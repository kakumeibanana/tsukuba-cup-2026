const info = [
  ...
  { label: '開催期間', value: '6月8日（月）〜 7月12日（月）', sub: '昼休み開催' },
  { label: '会場',     value: 'コート面（バスケコート側）' },
  { label: '形式',     value: '予選リーグ → 決勝トーナメント' },
]

const schedule = [
  { date: '6/8（月）',  events: ['予選リーグ 第1節'] },
  { date: '6/15（月）', events: ['予選リーグ 第2節'] },
  { date: '7/6（月）',  events: ['決勝トーナメント 準決勝'] },
  { date: '7/12（月）', events: ['決勝・表彰式'] },
]

const dailyFlow = [
  { time: '12:20',       desc: '担当各局員・第1試合出場チーム 集合' },
  { time: '12:25–12:35', desc: '第1試合（前後半 各5分）' },
  { time: '12:30',       desc: '第2試合出場チーム 集合' },
  { time: '12:40–12:50', desc: '第2試合（前後半 各5分）' },
  { time: '12:55–13:00', desc: '片付け・解散' },
]

const rules = [
  { title: '人数',       body: '5人（キーパー含む）' },
  { title: '試合時間',   body: '前後半 各5分・計10分。引き分けはPK戦（各3回→サドンデス）' },
  { title: 'メンバー交代', body: 'キーパー以外はプレー中いつでも・何人でも交代可。キーパーの交代は前後半の間のみ' },
  { title: 'キックイン', body: 'ボールがタッチラインを割ったら相手側キックインで再開。相手は5m以上離れ、4秒以内に蹴る' },
  { title: 'ゴールクリアランス', body: '攻撃側が触れたボールがエンドラインを割った場合、キーパーが手で投げ入れて再開（4秒以内）' },
  { title: '4秒ルール',  body: 'キーパーがハーフライン手前でボールを保持できるのは4秒以内' },
  { title: 'オフサイド', body: 'なし' },
  { title: 'バックパス', body: 'サッカーのルールに準ずる（キーパーが手で触れない限り、味方は何度でもパス可）' },
]
...
const format = [
  ...
  { label: '表彰', body: '優勝・準優勝・3位・累計得点最多チーム・得点王を表彰' },
]
